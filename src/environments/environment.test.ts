export const environment = {
  production: false,
  basePath: 'https://content-iis-tst.sebank.se/components/financialmarket/financialmarket-fundlist-pwa/test/',
  custodyTradingPwaBasePath: 'https://content-iis-tst.sebank.se/components/financialmarket/custody-trading/test/#/',
  infrontTokenUrlLive: 'https://publicapi-iis-tst.sebank.se/funds/v1.2/fundlist/infront/auth',
