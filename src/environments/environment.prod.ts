export const environment = {
  production: true,
  basePath: 'https://content.seb.se/components/financialmarket/financialmarket-fundlist-pwa/prod/',
  custodyTradingPwaBasePath: 'https://mp.seb.se/components/financialmarket/custody-trading/prod/#/',
  infrontTokenUrlLive: 'https://api.seb.se/open/prod/fundlist/v2/infront/auth',
  analyticsPath: 'https://content.seb.se/DA/191120/AppPrivat/71e07657e0b1660036c6a3a1ee5aeea1a106b3e8/satelliteLib-1903d55effa0f2befbeb99ab2e0c73dac4304621.js',
