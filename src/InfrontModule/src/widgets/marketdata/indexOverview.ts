...
@Component({
    selector: 'indexoverview',
    template: '<div #ioElement ></div>',
    changeDetection: ChangeDetectionStrategy.OnPush
})

export class IndexOverview extends BaseWidgetWrapper{
    @ViewChild('ioElement') targetElement: ElementRef;
    ...
    protected async createWidget(): Promise<Infront.InfrontWidget> {
        ...
        return infront.indexOverviewWidget(this.targetElement.nativeElement, this._widgetOptions);
    }
}
