...
export class IntradayTradesSimple extends BaseWidgetWrapper {
    ...
    protected async createWidget(): Promise<Infront.InfrontWidget> {
        ...
        return infront.intradayTradesSimpleWidget(this.targetElement.nativeElement, this._widgetOptions);
    }
}
