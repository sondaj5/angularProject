...
@Component({
    selector: 'tradingpower',
    template: '<span #targetElement></span>',
    changeDetection: ChangeDetectionStrategy.OnPush
})

export class TradingPower extends TradingWidgetWrapper {
    ...
    protected async createWidget(): Promise<Infront.InfrontWidget> {
        ...
        return infront.tradingPowerWidget(this.targetElement.nativeElement, this._widgetOptions);
    }
}
