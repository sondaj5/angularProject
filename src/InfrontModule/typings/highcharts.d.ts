...
//                 Juli�n Hanssens <https://github.com/hanssens>
...
declare namespace Highcharts {
    ...
    interface LangObject {
        ...
        shortMonths?: string[];
        /**
         * An array containing the weekday names in abbreviated form. Corresponds to the %a format in
         * Highcharts.dateFormat().
         * @default ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']
         */
    ...
    interface ChartObject {
        ...
        parentWidget?: Infront.ComplexChartWidget;
        navigator?: any;
        tooltip?: any;
        zoomOut?: any;
    }
    ...
    interface ChartMenuCustomButton {
        className: string;
        callback: () => void;
    }
    ...
    interface UIoptions {
        ...
        customButtons?: ChartMenuCustomButton[];
    ...
    interface OhlcPointObject extends Highcharts.PointObject {
        color?: string;
        dataLabels?: Highcharts.DataLabels;
        events?: Highcharts.PointEvents;
        graphic?: any;
        high?: number;
        id?: string;
        legendIndex?: number;
        low?: number;
        marker?: Highcharts.Marker;
        open?: number;
        sliced?: boolean;
    }
    ...
    interface CandlestickChart extends SeriesChart {
    }
    interface OhlcChart extends SeriesChart {
    }
}
